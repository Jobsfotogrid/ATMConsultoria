package br.com.jobsfotogrid.atmconsultoria.ui.sobre;
...
import br.com.jobsfotogrid.atmconsultoria.R;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return new  AboutPage(getActivity())
                ...
                .addFacebook("jobsfotogrid", "Facebook")
                .addTwitter("juniorflavio_oficial", "Twitter")
                .addGitHub("jobsfotogrid", "GitHub")
                .addInstagram("juniorflavio_oficial", "Instagram")
                .addItem(versao)
                .create();
